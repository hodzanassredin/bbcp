...
Пути в скриптах пока захардкожены — клонируйте именно сюда:
...
(Если путь другой — поправьте переменные `BB`/`USE` в начале
`tools64/mkworld64.sh`, `tools64/test64.sh`, `run-bb64`.)
