...
for m in "$@"; do
	case "$m" in
		...
		System*|Std*|Text*|Form*|Lin*|Cons*|Obx*|Odc*|Cuda*|Sql*|Xhtml*|Crypto*|Keep*|Lists*|Async*|Http*|Json*|Mcp*|Llm*|Hr*|Fjson*|Hyper*|Eds*|Fig*|Babel*|Coco*|Comm*|Cpc*|Aos*|Co_*|Kernel64) ;;
