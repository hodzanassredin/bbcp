...
typedef struct Module { struct Module *next; int opts, refcnt; short compTime[6], loadTime[6]; int ext; intptr_t term; int nofimps, nofptrs, csize, dsize, rsize; intptr_t code, data, refs, procBase, varBase; char* names; intptr_t* ptrs; struct Module* imports; void* export; char name[256]; } Module;
int main() {
